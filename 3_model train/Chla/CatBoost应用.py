...
file_path = r'excel\Chla_best_train_test_data.xlsx'
train_sheet_name = 'Training Set'
test_sheet_name = 'Test Set'

tif_path =        r"F:\4_Sentinel-3 OLCI_ENVI处理结果\20221221_S3B_OL1_EFR\20221221_S3B_EFR_bandlayerChla.tif"
output_tif_path = r"F:\4_Sentinel-3 OLCI_ENVI处理结果\20221221_S3B_OL1_EFR\20221221_S3B_EFR_Chla.tif"
...
#Read tif image data and perform chlorophyll concentration inversion
...
feature_b10_b9 = image_data[16, :, :]
feature_b7_b11_b8 = image_data[17, :, :]
...
feature_b10_b9_reshaped = feature_b10_b9.reshape(-1, 1)
feature_b7_b11_b8_reshaped = feature_b7_b11_b8.reshape(-1, 1)
...
all_features = np.hstack((spectral_features, feature_b10_b9_reshaped, feature_b7_b11_b8_reshaped, feature_cluster_reshaped))
